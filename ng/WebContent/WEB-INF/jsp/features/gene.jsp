...
<format:header title="Feature: ${uniqueName}">
 ...
 <script>
        ...
        function callBasket(uniqueName, historyType, callback) {
        ...
        function Basket() {
            ...
            self.select = function(uniqueName, fDisplay) {
                callBasket(uniqueName, "AUTO_BASKET", function(content) {
                    //$.log(uniqueName + " added to basket");
                });
            };
        }
...
<format:page>
 ...
 margin: auto;
 text-align: center;" class="spinner"></div>
